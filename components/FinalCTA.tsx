      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="reveal">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-10">
            <a href="https://health.pesquisemais.com.br/login" className="inline-flex items-center gap-3 bg-ink hover:bg-ink-soft text-white font-bold px-6 py-4 rounded-2xl shadow-lg transition-all hover:scale-[1.03] active:scale-[0.97]">
