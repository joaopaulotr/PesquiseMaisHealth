const footerLinks = {
  Páginas:  [
    ...
    { label: 'Sobre Nós', href: 'https://pesquisemais.com.br/sobre-nos' },
  ],
  Suporte:  [
    { label: 'Contato', href: 'https://pesquisemais.com.br/contato' },
    { label: 'Privacidade', href: 'https://www.nsapa.com.br/pmaissolucoes' },
  ],
}
...
const socials = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/pesquisemais',
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/pesquisemais/posts/?feedView=all',
      ...
      <div className="max-w-6xl mx-auto px-5 lg:px-8 py-14">
        ...
        <div className="border-t border-white/[0.07] pt-7 flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <div className="flex items-center gap-5 text-xs text-white/25 font-light">
            ...
            <a href="https://www.nsapa.com.br/pmaissolucoes" target="_blank" rel="noopener noreferrer" className="hover:text-white/50 transition-colors">Política de Privacidade</a>
          </div>
        </div>
